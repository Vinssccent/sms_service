"""add_provider_ips_table

Revision ID: 8661584e3cb2
Revises: 42fbf50db234
Create Date: 2025-08-30 20:56:10.647780
...
revision: str = '8661584e3cb2'
down_revision: Union[str, Sequence[str], None] = '42fbf50db234'
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('provider_id', 'ip_cidr', name='_provider_ip_uc')
    )
    op.create_index(op.f('ix_provider_ips_provider_id'), 'provider_ips', ['provider_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_provider_ips_provider_id'), table_name='provider_ips')
